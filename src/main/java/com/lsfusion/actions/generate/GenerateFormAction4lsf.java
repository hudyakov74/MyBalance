...
public abstract class GenerateFormAction4lsf {
    public   String prefixNonLatinVar;
    ...
    private Set<String> keywords = new HashSet<>(Arrays.asList("TRUE", "FALSE", "TTRUE", "TFALSE", "INTEGER", "LONG", "NUMERIC", "DOUBLE", "DATE", "DATETIME", "TIME", "YEAR",
            ...
            "CANONICALNAME", "CSV", "CUSTOM", "CYCLES", "DATA", "DB", "DBF", "DEFAULT",
            "DEFAULTCOMPARE", "DELAY", "DELETE", "DESC", "DESIGN", "DIALOG", "DO", "DOC", "DOCKED", "DOCX", "DOWN", "DRAWROOT", "DRILLDOWN", "DROP", "DROPCHANGED", "DROPPED",
            "ECHO", "EDIT", "ELSE", "EMAIL", "EMBEDDED", "END", "ESCAPE", "EVAL", "EVENTID", "EVENTS", "EXCEPTLAST", "EXCLUSIVE", "EXEC", "EXPAND", "EXTERNAL", "NEWEXECUTOR", "EXPORT",
            "EXTEND", "EXTID", "EXTNULL", "FIELDS", "FILTER", "FILTERBOX", "FILTERCONTROLS", "FILTERGROUP", "FILTERGROUPS", "FILTERS", "FINALLY",
            ...
            "NOCOMPLEX", "NODEFAULT", "NOEXTID", "NOESCAPE", "NOFLEX", "NOCHANGE", "NOCONSTRAINTFILTER", "NOINLINE", "NOHEADER", "NOSETTINGS", "NOT", "WAIT", "NOWAIT", "NULL", "NONULL",
            "NOSTICKY", "OBJECT", "OBJECTS", "CONSTRAINTFILTER", "OK", "ON", "OPTIMISTICASYNC", "OPTIONS", "OR", "ORDER", "ORDERS", "OVERRIDE", "PAGESIZE", "PANEL", "PARENT", "PARTITION", "PASSWORD",
            "PDF", "PERIOD", "PIVOT", "PG", "POPUP", "POSITION", "POST", "PREREAD", "PREV", "PREVIEW", "NOPREVIEW", "PARAMS", "PRINT", "PRIORITY", "PROPERTIES", "PROPERTY", "PROPERTYDRAW",
            "PROPORTION", "PUT", "QUERYCLOSE", "QUICKFILTER", "READ", "READONLY", "READONLYIF", "RECALCULATE", "RECURSION", "REFLECTION", "REGEXP", "REMOVE",
            "REPORT", "REPORTFILES", "REQUEST", "REQUIRE", "RESOLVE", "RETURN", "RGB", "RIGHT", "ROUND", "ROOT", "ROW",
            "ROWS", "RTF", "SCROLL", "SEEK", "SELECTED", "SELECTOR", "SERIALIZABLE", "SERVER",
            "SET", "SETCHANGED", "SETDROPPED", "SETTINGS", "SCHEDULE", "SHOW", "SHOWDEP", "SHOWIF", "SINGLE", "SHEET", "SPLITH", "SPLITV", "SQL", "START", "STEP", "STICKY",
            "STRICT", "STRUCT", "SUBJECT", "SUBREPORT", "SUM", "TAB", "TABBED", "TABLE", "TAG", "TCP", "TEXTHALIGN", "TEXTVALIGN", "THEN", "THREADS", "TO", "DRAW", "TOOLBAR",
            "TOOLBARBOX", "TOOLBARLEFT", "TOOLBARRIGHT", "TOOLBARSYSTEM", "TOP", "TREE", "TRY", "TSQUERY", "TSVECTOR", "UDP", "UNGROUP", "UP", "USERFILTER", "USERFILTERS", "VALIGN", "VALUE", "VERTICAL", "VIEW", "WHEN",
      ...
      abstract List<ParseNode> generateHierarchy(Object element, String key);
            ...
            try {
                if(text != null && !text.isEmpty()) {
                    ...
                    if (rootElement != null) {
                        ...
                        return showFormScript(formCodeBlock);
                    }
                }
            } catch (Exception e) {
        ...
        private String showFormScript(CodeBlock formCodeBlock) {
            Form form = generateFormFromCodeBlocks(formCodeBlock);

            String formScript =
                            (form.groupDeclarationScripts.isEmpty() ? "" : (String.join("\n", form.groupDeclarationScripts) + "\n\n")) +
                            (form.propertyDeclarationScripts.isEmpty() ? "" : (String.join("\n",form.propertyDeclarationScripts) + "\n\n")) +
                            form.formNameScript + "\n" +
                            (form.formScripts.isEmpty() ? "" : String.join("\n",form.formScripts)) + ";";
    ...
    private String getFilterProperty(ElementKey key, ElementKey childKey) {
        return key != null ? (key.ID +  capitalize(childKey.ID)) : null;
    }
    ...
    private String generateObjectId(String id) {
        ...
        if(id != null) {
            if(prefixNonLatinVar != null){
                id = prefixNonLatinVar + id;
            }
